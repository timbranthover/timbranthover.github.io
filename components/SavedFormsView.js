                  ...
                  <div className="flex items-start justify-between gap-4">
                      ...
                      {isExpanded && (
                        <div className="mt-4 pt-4 border-t border-gray-200 ml-8">
                          <div className="flex items-start justify-between gap-4 mb-4 pr-1">
                            ...
                            >
                              <svg className="w-4 h-4 fill-blue-600 stroke-blue-600" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z" />
                              </svg>
                              Saved
                            </button>
                    ...
                    <div className="flex items-start gap-2 flex-shrink-0">
                      {form.eSignEnabled ? (
                        ...
                        <div className="flex items-center gap-1.5 px-2.5 py-1 bg-gray-100 text-gray-600 rounded text-xs font-medium">
                          <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
