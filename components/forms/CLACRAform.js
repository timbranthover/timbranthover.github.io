  ...
  return (
    <div className="bg-white shadow-lg max-w-3xl mx-auto p-8 space-y-6">
      <div className="border-b-2 border-gray-900 pb-4">
        ...
        <p className="text-sm text-gray-600 mt-1">Establish an investment advisory relationship</p>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="border-t pt-6">
          <h3 className="font-semibold text-gray-900 mb-3">Advisory Details</h3>
          <div className="space-y-4">
            <div>
              <label className="block text-xs font-medium text-gray-700 mb-1">Advisor Name</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-xs font-medium text-gray-700 mb-1">Fee Schedule</label>
              <input
                type="text"
        ...
        <div className="border-t-2 border-gray-900 pt-6">
          ...
          <p className="text-xs text-gray-600 mb-4">By signing, you agree to the terms of the investment advisory relationship as outlined above.</p>
