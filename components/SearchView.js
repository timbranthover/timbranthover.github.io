    ...
    <div className="space-y-6 max-w-5xl">
      ...
      <div className="border border-gray-300 rounded-lg bg-white overflow-hidden transition-colors hover:border-gray-300">
        <button
          ...
          className="w-full px-6 py-4 flex items-center justify-between hover:bg-gray-50 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-inset"
        >
          <div className="text-left">
            <span className="text-sm font-medium text-gray-700">Other search options</span>
            <p className="text-xs text-gray-500 mt-0.5">Browse by full library, saved forms, and category</p>
          </div>
        ...
        {showOtherOptions && (
          <div className="px-6 pb-6 pt-2 border-t border-gray-200 space-y-3">
            <button
              ...
              className="w-full text-left px-4 py-3 rounded hover:bg-gray-50 border border-gray-200 text-sm flex items-center gap-3 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-1"
            >
